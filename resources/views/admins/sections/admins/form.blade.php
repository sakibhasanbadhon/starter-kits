...
@section('button-area')
    <a href="{{ route('admin.manage-admins.roles.index') }}" class="btn btn-primary rounded-0 mb-0"><i
...
@section('content')
    <form id="role_form" method="POST" action="{{ route('admin.manage-admins.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-8">
