            ...
            <div class="card">
                <div class="card-header py-2">
                    <h4 class="mb-0 cd-title d-flex align-items-center justify-content-between">{{ $title }}
                        ...
                        <a href="{{ route('admin.users.create') }}" class="btn btn-sm btn-primary rounded-0"><i class="fas fa-plus fa-sm"></i> Add User</a>
                        @endpermission
                    </h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table-hover table-striped" id="admin-datatable">
                            <thead>
                                ...
                                <th>Created By</th>
                                <th>Created At</th>
                                @if (permission('user-edit') || permission('user-delete'))
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url = "{{ route('admin.users.delete') }}";
        ...
        $(document).on('click', '.change_status', function() {
            ...
            var url = "{{ route('admin.users.status-change') }}"
